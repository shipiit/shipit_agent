...
NB_37 = notebook(
    "Autopilot quickstart (Bedrock Llama)",
    [
        md(
...
NB_38 = notebook(
    "Autopilot live streaming (Claude-Desktop-style)",
    [
        md(
...
NB_39 = notebook(
    "Persistence, resume, and the scheduler daemon",
    [
        md(
...
NB_40 = notebook(
    "Developer · Debugger · Researcher specialists",
    [
        md(
...
NB_41 = notebook(
    "Design · PM · Sales · CS · Marketing specialists",
    [
        md(
...
NB_42 = notebook(
    "computer_use, hubspot_ops, research_brief — power tools",
    [
        md(
...
NB_43 = notebook(
    "Fan-out, Critic, and Artifacts — Claude-Desktop-grade Autopilot",
    [
        md(
...
NB_44 = notebook(
    "The Complete Tour — every Autopilot feature in one notebook",
    [
        md(
