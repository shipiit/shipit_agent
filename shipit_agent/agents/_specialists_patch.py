...
SPECIALISTS: list[dict] = [
    {
        ...
        "model": "sonnet",
        "tools": ["read_file", "write_file", "edit_file", "grep_search", "glob_search", "bash", "run_tests"],
        "skills": [],
        "maxIterations": 40,
    ...
    },
    {
        ...
        "model": "sonnet",
        "tools": ["read_file", "grep_search", "glob_search", "bash", "run_tests", "edit_file"],
        "skills": [],
        "maxIterations": 40,
    ...
    },
    {
        ...
        "model": "opus",
        "tools": ["read_file", "grep_search", "playwright_browser", "open_url", "web_search"],
        "skills": [],
        "maxIterations": 20,
    ...
    },
    {
        ...
        "model": "sonnet",
        "tools": ["read_file", "web_search", "notion", "linear", "write_file"],
        "skills": [],
        "maxIterations": 20,
    ...
    },
    {
        ...
        "model": "sonnet",
        "tools": ["web_search", "open_url", "hubspot_ops", "gmail", "write_file"],
        "skills": [],
        "maxIterations": 15,
    ...
    },
    {
        ...
        "model": "sonnet",
        "tools": ["hubspot_ops", "gmail", "slack", "linear", "notion", "read_file", "write_file"],
        "skills": [],
        "maxIterations": 15,
    ...
    },
    {
        ...
        "model": "sonnet",
        "tools": ["web_search", "open_url", "read_file", "write_file", "notion"],
        "skills": [],
        "maxIterations": 15,
